...
{
	bool loaded =TextureManager::getInstance()->load("spritelib_gpl/fishdish/fishbaddie_parts.png","fishbaddie_parts1",TheGame::Instance()->getRenderer());

	if(!loaded)
	{
	return false;
	}
	loaded =TextureManager::getInstance()->load("spritelib_gpl/fishdish/fishbaddie_parts.png","fishbaddie_parts2",TheGame::Instance()->getRenderer());
	if(!loaded)
	{
		return false;
	}
